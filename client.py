...
class AzureSearch(object):
        ...
        def manageregenerateadminkey(self, subscriptionId, resourceGroupName, regenerateKey):
                return "https://management.azure.com/subscriptions/" + subscriptionId + "/resourceGroups/" + resourceGroupName + "/providers/Microsoft.Search/searchServices/" + self.serviceName + "/regenerateAdminKey/" + regenerateKey + "?" + self.version     
